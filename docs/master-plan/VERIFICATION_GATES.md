...
Automated integration tests never connect to Cloudflare or IBKR.
...
- narrowly selected Quantt source samples against source documentation;
- IBKR paper-recording schema generated by fakes;
- credential/account redaction;
- staged canonical row counts, ranges, hashes, duplicates, and spot checks;
